...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Camera.showSteps == True: # show steps #######################################################
    ...
    if Camera.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, Camera.SCALAR_WHITE)
    ...
    if Camera.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), Camera.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), Camera.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), Camera.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), Camera.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if Camera.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, Camera.SCALAR_WHITE)
        # end if # show steps #####################################################################
